...
var items = [
	...
	[["coercion", 2], "DashedSentence", {s: "The secretary began the memo before the annual sales conference."}, 
                          "Question", {q: "The conference was…", hasCorrect: "a sales conference", as: ["a medical conference","an advertising conference","a sales conference"]}],
	...
	[["coercion", 4], "DashedSentence", {s: "The author was starting the book in his house on the island."}, 
                          "Question", {q: "His house was…", hasCorrect: "on the island", as: ["on the island","on the mountain","in the valley"]}],
	...
	[["coercion", 7], "DashedSentence", {s: "The doctor expected the report before the patient returned for further tests."}, 
                          "Question", {q: "The patient needed…", hasCorrect: "further tests", as: ["further tests","medication","surgery"]}],
	...
	[["coercion", 11], "DashedSentence", {s: "The receiver tried the door to the basement."}, 
                          "Question", {q: "The door was…", hasCorrect: "to the basement", as: ["on the second floor","to the attic","to the basement"]}],
	...
	[["coercion", 12], "DashedSentence", {s: "The customer started the dinner at the new French restaurant."}, 
                          "Question", {q: "The restaurant was…", hasCorrect: "French", as: ["Mexican","Chinese","French"]}],
	...
	[["coercion", 13], "DashedSentence", {s: "The nurse preferred the velvet and the jet black silk."}, 
                          "Question", {q: "The color of the silk was…", hasCorrect: "jet black", as: ["baby blue","jet black","rose pink"]}],
	...
	[["coercion", 17], "DashedSentence", {s: "The composer was attempting the solo before the spring concert."}, 
                          "Question", {q: "The concert was…", hasCorrect: "in spring", as: ["in spring","in fall","in winter"]}],
	...
	[["coercion", 19], "DashedSentence", {s: "The dieter resisted the ice cream at her niece's birthday party."}, 
                          "Question", {q: "The party was…", hasCorrect: "for a niece", as: ["for a brother","for a niece","for a husband"]}],
	...
	[["coercion", 21], "DashedSentence", {s: "The architect started the house in his studio downtown."}, 
                          "Question", {q: "The studio was…", hasCorrect: "downtown", as: ["five miles away","uptown","downtown"]}],
	...
	[["coercion", 22], "DashedSentence", {s: "The teacher was enjoying the sandwich in the lunch room."}, 
                          "Question", {q: "The teacher had…", hasCorrect: "a sandwich", as: ["five carrots","some soup","a sandwich"]}],
	...
	[["coercion", 28], "DashedSentence", {s: "The cook started the meal at the restaurant near the river."}, 
                          "Question", {q: "The restaurant was…", hasCorrect: "near the river", as: ["by the docks","at the wharf","near the river"]}],
